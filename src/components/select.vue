<template>
  <div class="record">
    <search
      ...
      ref="search"></search>
      <!-- :results="results" -->
        <flexbox :gutter="0" class='select-title vux-1px-r'>
            <flexbox-item>
                <div class="flex-demo">
                    <group :gutter='0'>
                        <cell
...
<script>
  import { Search, Group, Cell, Flexbox, FlexboxItem, Panel, XButton, CellBox, Card } from 'vux';
  export default {
      components: {
        Search,
        Group,
